...
## Testing the parameters on QMD file


```{python}
#| echo: false
full_path = str(image_path)  + image_url
print()
print("image path: ", image_path)
print("abstr url: ", "/statistic/barcode/counts/{condition}_{config}_{type}_perBarcode.png")
print("fstrr url: ", "/statistic/barcode/counts/{condition}_{config}_{type}_perBarcode.png")
