...
def cli(input_file, output_file):
    ...
    output = pd.DataFrame({"Counts": [bcs, assigned_bcs, matched_oligos, other_bcs, ambiguous_bc]}, index=["Total BCs", "Total assigned BCs", "Total assigned oligos", "Total other BCs", "Total ambiguous BCs"])
