...
def read_sequence_file(infile, sec_read_start=None):
    ...
    if options.nextera and ireadl2 != None:
        for seqid, seq, qual in read_fastq(infile):
            ...
            if qual != None and options.qualityoffset != 33: qual = "".join(
                [chr(ord(x) - options.qualityoffset + 33) for x in qual])
            if sec_read_start == None:
                if qual != None:
                    yield seqid, seq[-(ireadlength1 + ireadlength2):-ireadlength2], qual[-(
                            ireadlength1 + ireadlength2):-ireadlength2], seq[-ireadlength2:], qual[-ireadlength2:], seq[
                                                                                                                    :-(
                                                                                                                            ireadlength1 + ireadlength2)], qual[
                                                                                                                                                           :-(
                                                                                                                                                                   ireadlength1 + ireadlength2)], None, None
                else:
                    yield seqid, seq[-(ireadlength1 + ireadlength2):-ireadlength2], None, seq[
                                                                                          -ireadlength2:], None, seq[:-(
                            ireadlength1 + ireadlength2)], None, None, None
            else:
                if qual != None:
                    yield seqid, seq[
                                 (sec_read_start - ireadlength1 - ireadlength2):(sec_read_start - ireadlength2)], qual[(
                                                                                                                               sec_read_start - ireadlength1 - ireadlength2):(
                                                                                                                               sec_read_start - ireadlength2)], seq[
                                                                                                                                                                (
                                                                                                                                                                        sec_read_start - ireadlength2):(
                                                                                                                                                                    sec_read_start)], qual[
                                                                                                                                                                                      (
                                                                                                                                                                                              sec_read_start - ireadlength2):(
                                                                                                                                                                                          sec_read_start)], seq[
                                                                                                                                                                                                            :(
                                                                                                                                                                                                                    sec_read_start - ireadlength1 - ireadlength2)], qual[
                                                                                                                                                                                                                                                                    :(
                                                                                                                                                                                                                                                                            sec_read_start - ireadlength1 - ireadlength2)], seq[
                                                                                                                                                                                                                                                                                                                            sec_read_start:], qual[
                                                                                                                                                                                                                                                                                                                                              sec_read_start:]
                else:
                    yield seqid, seq[(sec_read_start - ireadlength1 - ireadlength2):(
                            sec_read_start - ireadlength2)], None, seq[(sec_read_start - ireadlength2):(
                        sec_read_start)], None, seq[:(sec_read_start - ireadlength1 - ireadlength2)], None, seq[
                                                                                                            sec_read_start:], None
        ...
        for seqid, seq, qual in read_fastq(infile):
            ...
            if sec_read_start == None:
                if qual != None:
                    yield seqid, seq[-ireadlength1:], qual[-ireadlength1:], "", None, seq[:-ireadlength1], qual[
                                                                                                           :-ireadlength1], None, None
                else:
                    yield seqid, seq[-ireadlength1:], None, "", None, seq[:-ireadlength1], None, None, None
            else:
                if qual != None:
                    if ireadl2 == None:
                        yield seqid, seq[(sec_read_start - ireadlength1):sec_read_start], qual[(
                                                                                                       sec_read_start - ireadlength1):sec_read_start], "", None, seq[
                                                                                                                                                                 :(
                                                                                                                                                                         sec_read_start - ireadlength1)], qual[
                                                                                                                                                                                                          :(
                                                                                                                                                                                                                  sec_read_start - ireadlength1)], seq[
                                                                                                                                                                                                                                                   sec_read_start:], qual[
                                                                                                                                                                                                                                                                     sec_read_start:]
                    else:
                        yield seqid, seq[(sec_read_start - ireadlength1):sec_read_start], qual[(
                                                                                                       sec_read_start - ireadlength1):sec_read_start], seq[
                                                                                                                                                       ireadl2:], qual[
                                                                                                                                                                  ireadl2:], seq[
                                                                                                                                                                             :(
                                                                                                                                                                                     sec_read_start - ireadlength1)], qual[
                                                                                                                                                                                                                      :(
                                                                                                                                                                                                                              sec_read_start - ireadlength1)], seq[
                                                                                                                                                                                                                                                               sec_read_start:ireadl2], qual[
                                                                                                                                                                                                                                                                                        sec_read_start:ireadl2]
                else:
                    if ireadl2 == None:
                        yield seqid, seq[(sec_read_start - ireadlength1):sec_read_start], None, "", None, seq[:(
                                sec_read_start - ireadlength1)], None, seq[sec_read_start:], None
                    else:
                        yield seqid, seq[(sec_read_start - ireadlength1):sec_read_start], None, seq[
                                                                                                ireadl2:], None, seq[:(
...
parser.add_option("-l", "--ireadlength", dest="ireadlength1",
                  help="Length of index read (in case it is longer than the indexes in the index file provided)",
                  type="int", default=0)
parser.add_option("-m", "--2nd_ireadlength", dest="ireadlength2",
                  help="Length of a second index read (in case it is longer than the indexes in the index file provided)",
                  type="int", default=0)
parser.add_option("--qualityoffset", dest="qualityoffset",
                  help="Offset of quality scores in FastQ input file (default 33)", type="int", default=33)
...
group.add_option("-q", "--quality", dest="quality",
                 help="Minimum quality score of bases in both indexes (default 0:off)", type='int', default=0)
group.add_option("--qualityN", dest="qualityN",
                 help="Consider subset of bases for quality score filter (e.g. NyyyyyN removes first and last base)",
                 default="")
group.add_option("--2nd_qualityN", dest="qualityN_2nd",
                 help="Consider subset of bases for quality score filter (e.g. NyyyyyN removes first and last base)",
                 default="")
...
group.add_option("", "--outprefix", dest="outprefix", help="Prefix for output files (default 'demultiplex').",
                 default="demultiplex")
group.add_option("", "--SAM", dest="SAM", help="Output SAM not BAM.", default=False, action="store_true")
group.add_option("--summary", dest="summary", help="Show summary for reads writen to separate files", default=False,
                 action="store_true")
...
for filename in files:
    ...
    for seqid, oindseq1, oindqual1, oindseq2, oindqual2, r1, q1, r2, q2 in read_sequence_file(infile,
                                                                                              sec_read_start=options.start):
