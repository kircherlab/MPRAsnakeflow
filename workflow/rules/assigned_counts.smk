...
rule assignBarcodes:
    ...
    input:
        ...
        script="../scripts/count/merge_BC_and_assignment.py",
    output:
...
rule createAssignmentPickleFile:
    ...
    input:
        ...
        script="../scripts/count/create_pickle.py",
    output:
...
rule dna_rna_merge:
    ...
    input:
        ...
        association=lambda wc: getAssignmentFile(wc.project, wc.assignment),
        script="../scripts/count/merge_label.py",
    output:
...
rule make_master_tables:
    ...
    input:
        ...
        script="../scripts/count/make_master_tables.R",
    output:
