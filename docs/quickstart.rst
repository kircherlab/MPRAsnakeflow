...
4. Run MPRAsnakeflow
  ...
  The assignment files generated by the workflow, are named: :code:`assignment_barcodes.<config>.sorted.tsv.gz` and can be found in the :code:`results/assignment/<assignment>/` folder.
