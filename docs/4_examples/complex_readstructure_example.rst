...
For the experiment all output files will be in the :code:`results/experiment/abellEtAl` folder. The final count file is :code:`results/experiment/abellEtAl/reporter_experiment.barcode.GM12878.SRR14567164SRR14567165Assignment.default.all.tsv.gz` for the barcode file and :code:`results/experiment/abellEtAl/reporter_experiment.oligo.GM12878.SRR14567164SRR14567165Assignment.default.all.tsv.gz` for the aggregated oligo files. Also you should have a look at the QC report: :code:`results/experiment/abellEtAl/qc_report.GM12878.SRR14567164SRR14567165Assignment.default.html`. You can find an example QC report here: `Example experiment QC report <https://htmlpreview.github.io/?https://github.com/kircherlab/MPRAsnakeflow/blob/master/docs/4_examples/abeletall.qc_report.GM12878.SRR14567164SRR14567165Assignment.default.html>`_.
