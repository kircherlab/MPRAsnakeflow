...
This example runs the assignment and the experiment/count workflow on 5'/5' WT MPRA data in the HepG2 cell line from `Klein J., Agarwal, V., Keith, A., et al. 2019 <http://dx.doi.org/10.1038/s41592-020-0965-y>`_.
